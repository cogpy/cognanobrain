...
import { Brain, Network, Calculator, GitBranch, Eye } from 'lucide-react';
import { 
  AtomeseNode, 
...
export const FundamentalFeaturesPanel: React.FC<FundamentalFeaturesProps> = ({ 
  ...
  const [activeFeature, setActiveFeature] = useState<'philosophical' | 'fractal' | 'prime-metric'>('philosophical');
