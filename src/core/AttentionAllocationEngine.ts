...
export class AttentionAllocationEngine {
   ...
   */
  private applyHybridAttention(nodeTensors: NodeTensor[], _linkTensors: LinkTensor[]): AttentionStats {
   ...
   */
  private applyGradientUpdates(nodeTensors: NodeTensor[], _linkTensors: LinkTensor[]): void {
   ...
   */
  private recordAttentionFlows(nodeTensors: NodeTensor[], linkTensors: LinkTensor[]): void {
