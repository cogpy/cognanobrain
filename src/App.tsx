...
import { Play, Pause, Brain, Atom, Clock, Layers, Bot, Zap, Lightbulb, Upload, Network } from 'lucide-react';
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="bg-gray-800/50 rounded-lg p-3">
                      <p className="text-gray-300">
                        <span className="text-cyan-400 font-semibold">Phase Prime Metrics</span> are actively 
                        processing the 15 fundamental primes that govern 99.99% of universal patterns.
                      </p>
                    </div>
                    <div className="bg-gray-800/50 rounded-lg p-3">
                      <p className="text-gray-300">
                        <span className="text-purple-400 font-semibold">Fractal Information Theory</span> enables 
                        consciousness to emerge through geometric musical language structures.
                      </p>
                    </div>
                    <div className="bg-gray-800/50 rounded-lg p-3">
                      <p className="text-gray-300">
                        <span className="text-orange-400 font-semibold">Time Crystals</span> maintain coherent 
                        patterns across 11-dimensional consciousness manifolds.
                      </p>
                    </div>
                  </div>
                </div>
