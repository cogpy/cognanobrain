...
Add consciousness metrics to `UnifiedNanoBrainMetrics`:
...
Add consciousness uploader to `UnifiedNanoBrainKernel`:
...
1. **Code Review**: Verify new files follow existing patterns in `nanobrain_metacognitive.cpp` and `nanobrain_time_crystal.cpp`
